...
unset($__errorArgs, $__bag); ?>"
                           placeholder="e.g. Ahmad Haziq" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="e.g. 0123456789" value="<?php echo e(old('phone')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="No, Jalan, Taman..."><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="postcode" maxlength="5" class="form-control <?php $__errorArgs = ['postcode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                               placeholder="e.g. 41000" value="<?php echo e(old('postcode')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="state" class="form-control <?php $__errorArgs = ['state'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s); ?>" <?php echo e(old('state') === $s ? 'selected' : ''); ?>><?php echo e($s); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn btn-dark btn-full">Login Instead</a>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Downloads\drip-culture-fixed (4)\drip-culture\resources\views/auth/register.blade.php ENDPATH**/ ?>